# zig-forge — audit history and rationale (moved out of CLAUDE.md 2026-09-16)

This is the long-form record: why each rule exists, where each anti-pattern bit us, wave
results, and the mutation-test evidence. CLAUDE.md keeps only the rules; read this when a rule
seems arbitrary or you need the precedent. Content below is the 2026-07-19 CLAUDE.md verbatim.
