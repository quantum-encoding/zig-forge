...
echo ""
ls -lh zig-out/lib/libzig_docx.*
echo ""
echo "Symbols exported:"
nm -gU zig-out/lib/libzig_docx.a 2>/dev/null | grep "T _zig_docx" | wc -l | tr -d ' '
