...
Master roadmap for ext2→ext3→ext4 filesystem progression, broken into agent-parallelizable milestones with folder structure and CLAUDE.md per component
