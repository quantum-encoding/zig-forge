...
| `show_branding`                | bool                             | No        | `true`; `false` for `preset:"receipt"` / `preset:"minimal"` | "Generated by Quantify" footer link                                     |
...
- `payment_buttons[]` — engine renders multiple clickable pay buttons; builder needs UI to add Stripe/PayPal/etc rows
