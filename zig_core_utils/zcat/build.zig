...
pub fn build(b: *std.Build) void {
    ...
    // GNU-parity tests: shell out to the built zcat and (when installed) the
    // real GNU coreutils cat, byte-comparing stdout + exit codes.
    const test_options = b.addOptions();
    test_options.addOptionPath("zcat_exe", exe.getEmittedBin());
